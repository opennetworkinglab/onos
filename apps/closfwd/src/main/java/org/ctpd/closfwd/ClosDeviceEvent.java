 ...
 */
public class ClosDeviceEvent extends AbstractEvent<ClosDeviceEvent.Type, DeviceId> {
     ...
     */
    public ClosDeviceEvent(Type type, DeviceId deviceId,
                             VlanId sVlanId,
                             VlanId cVlanId) {
        super(type, deviceId);
     ...
     * @param cVlanId the customer vlan
     */
    protected ClosDeviceEvent(Type type, DeviceId deviceId, long time,
                                VlanId sVlanId,
                                VlanId cVlanId) {
