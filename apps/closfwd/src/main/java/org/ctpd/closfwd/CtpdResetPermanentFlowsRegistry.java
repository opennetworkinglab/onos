 ...
 */
@Service
@Command(scope = "onos", name = "purge-flows-registry",
        description = "Purge permanent flowids registry")

public class CtpdResetPermanentFlowsRegistry extends AbstractShellCommand {
    ...
    protected void doExecute() {
        ...
        print("FlowId Permanent Register size: "+get(ClosDeviceService.class).resetPermanentFlowIdRegister());
    }
}