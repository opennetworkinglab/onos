 ...
 */
@Service
@Command(scope = "onos", name = "install-clos-controller-flows",
        description = "Install clos controller flows")
public class CtpdInstallClosControllerFlows extends AbstractShellCommand {
    ...
    protected void doExecute() {
        ...
        service.installControllerFlowsL2L3L4Devices();
