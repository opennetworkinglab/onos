 ...
 */
@Service
@Command(scope = "onos", name = "clos-registry-size",
        description = "Size of CTPD registry")
public class CtpdRegisterSizeCommand extends AbstractShellCommand {
    ...
    protected void doExecute() {
        ...
        print("Registry size: "+service.getSize());
    }
}