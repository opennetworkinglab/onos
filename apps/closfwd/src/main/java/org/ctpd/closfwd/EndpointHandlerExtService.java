...
public  class EndpointHandlerExtService implements EndpointHandler{

    // ClosDeviceService service;

    public EndpointHandlerExtService(){
    ...
    public void create(Endpoint endpoint, Boolean create){
        log.debug("create-external-servie-start-"+create);
        ...
        log.debug("create-external-servie-end-"+create);
    }
