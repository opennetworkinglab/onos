...
def generated_maven_jars():
    ...
    if "atomix" not in native.existing_rules():
        java_import_external(
            name = "atomix",
            jar_sha256 = "a2eec784aaaf6ef3496d7e8ba9ec21ca5068ebc0965bd5e1a61290998bed5afb",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix/3.1.0-rc2/atomix-3.1.0-rc2.jar"],        )
    if "atomix_cluster" not in native.existing_rules():
        java_import_external(
            name = "atomix_cluster",
            jar_sha256 = "1dc86b57c67cdc1653b1d8207dc7432da9354f0524db45ee4c189ba2ef2445eb",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix-cluster/3.1.0-rc2/atomix-cluster-3.1.0-rc2.jar"],        )
    if "atomix_primary_backup" not in native.existing_rules():
        java_import_external(
            name = "atomix_primary_backup",
            jar_sha256 = "3b713209ad3a16bb7ddd3aec5892a3f6d42b20218a183eeae3d12bda6bb43d57",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix-primary-backup/3.1.0-rc2/atomix-primary-backup-3.1.0-rc2.jar"],        )
    if "atomix_primitive" not in native.existing_rules():
        java_import_external(
            name = "atomix_primitive",
            jar_sha256 = "128d8b2e06d346afc0b83b0ea4edaf9fdfba9d6656c3a3bcbe30e902b24f30ab",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix-primitive/3.1.0-rc2/atomix-primitive-3.1.0-rc2.jar"],        )
    if "atomix_raft" not in native.existing_rules():
        java_import_external(
            name = "atomix_raft",
            jar_sha256 = "665c5fe1eca720906897c9e99902588cff55ac6f2f124a905e1d2e2340420998",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix-raft/3.1.0-rc2/atomix-raft-3.1.0-rc2.jar"],        )
    if "atomix_storage" not in native.existing_rules():
        java_import_external(
            name = "atomix_storage",
            jar_sha256 = "d9717ebbb47e7f8ca4d475e8cc879fc53ccbc7cad6e5b80ee2d03e6ddf2fd8dc",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix-storage/3.1.0-rc2/atomix-storage-3.1.0-rc2.jar"],        )
    if "atomix_utils" not in native.existing_rules():
        java_import_external(
            name = "atomix_utils",
            jar_sha256 = "4c156f7bbe7cf576387ba0b527de71fffe37af88ba1a150756bc5cfb2eb8839a",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix-utils/3.1.0-rc2/atomix-utils-3.1.0-rc2.jar"],        )
...
artifact_map["@atomix//:atomix"] = "mvn:io.atomix:atomix:jar:3.1.0-rc2"
artifact_map["@atomix_cluster//:atomix_cluster"] = "mvn:io.atomix:atomix-cluster:jar:3.1.0-rc2"
artifact_map["@atomix_primary_backup//:atomix_primary_backup"] = "mvn:io.atomix:atomix-primary-backup:jar:3.1.0-rc2"
artifact_map["@atomix_primitive//:atomix_primitive"] = "mvn:io.atomix:atomix-primitive:jar:3.1.0-rc2"
artifact_map["@atomix_raft//:atomix_raft"] = "mvn:io.atomix:atomix-raft:jar:3.1.0-rc2"
artifact_map["@atomix_storage//:atomix_storage"] = "mvn:io.atomix:atomix-storage:jar:3.1.0-rc2"
artifact_map["@atomix_utils//:atomix_utils"] = "mvn:io.atomix:atomix-utils:jar:3.1.0-rc2"
