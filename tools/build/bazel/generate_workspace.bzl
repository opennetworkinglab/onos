# ***** This file was auto-generated at Mon, 10 Jan 2022 02:23:20 GMT. Do not edit this file manually. *****
# ***** Use onos-lib-gen *****
...
def generated_maven_jars():
    ...
    if "k8s_client" not in native.existing_rules():
        java_import_external(
            name = "k8s_client",
            jar_sha256 = "6a3c28366f0e3c8479bed445edddab850ef99736d3e97a985fbed494daad00c9",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-client/5.3.0/kubernetes-client-5.3.0.jar"],        )
    if "k8s_model" not in native.existing_rules():
        java_import_external(
            name = "k8s_model",
            jar_sha256 = "87d235924f7fd1ebfc3720cb909618508bd5c7e62933901e0c7903a8769e1c6c",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model/5.3.0/kubernetes-model-5.3.0.jar"],        )
    if "k8s_model_common" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_common",
            jar_sha256 = "66f7ea51386408cf4d1fc4076063f22558cd83cadf63fd4ed22a574ddf21e6ab",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-common/5.3.0/kubernetes-model-common-5.3.0.jar"],        )
    if "k8s_model_core" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_core",
            jar_sha256 = "f3033af90bec1976528cc00be24717f367a36a6523dc1f43723edd37c1ca5bcf",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-core/5.3.0/kubernetes-model-core-5.3.0.jar"],        )
    if "k8s_model_rbac" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_rbac",
            jar_sha256 = "e5a3ea2c08236b4f6f95a19eb26ba52f35533a7d51b5810b769aed733be8cdf2",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-rbac/5.3.0/kubernetes-model-rbac-5.3.0.jar"],        )
    if "k8s_model_admissionregistration" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_admissionregistration",
            jar_sha256 = "5067d02aa247077f1d6e2967a5a2811427ace76fd5a75eec192d993f69cb5777",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-admissionregistration/5.3.0/kubernetes-model-admissionregistration-5.3.0.jar"],        )
    if "k8s_model_apiextensions" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_apiextensions",
            jar_sha256 = "c6437997af2c4b6f58abdadd94253bea24e0099957cd71b7d7ef2cd8c7363ca0",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-apiextensions/5.3.0/kubernetes-model-apiextensions-5.3.0.jar"],        )
    if "k8s_model_batch" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_batch",
            jar_sha256 = "a0da20df6877e077af4a8d5d32b84535d4b892b5fc7cc6a1a703f511aca6c1f2",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-batch/5.3.0/kubernetes-model-batch-5.3.0.jar"],        )
    if "k8s_model_certificates" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_certificates",
            jar_sha256 = "061011f278e5011ad2e6055f4fd8cde3b31391231144e1b0e67f1e0d725115c3",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-certificates/5.3.0/kubernetes-model-certificates-5.3.0.jar"],        )
    if "k8s_model_coordination" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_coordination",
            jar_sha256 = "728af9f49b7d6213c7a5e6324d508ca0e5dbbfa8512e3aeb6f1121fed0d971d8",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-coordination/5.3.0/kubernetes-model-coordination-5.3.0.jar"],        )
    if "k8s_model_discovery" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_discovery",
            jar_sha256 = "70225c1c28dba48a9f256fce7eac71b5af5094533e8580636223706fadfc28b6",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-discovery/5.3.0/kubernetes-model-discovery-5.3.0.jar"],        )
    if "k8s_model_metrics" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_metrics",
            jar_sha256 = "891fcafc80183b718ae30e24588583eab3ae0ab39a608ebb109a2d632c9894cc",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-metrics/5.3.0/kubernetes-model-metrics-5.3.0.jar"],        )
    if "k8s_model_scheduling" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_scheduling",
            jar_sha256 = "1a513e1dfede8413c971e0fe7ae99af416b5d10f0a2889ad2e72561fa409508e",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-scheduling/5.3.0/kubernetes-model-scheduling-5.3.0.jar"],        )
    if "k8s_model_storageclass" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_storageclass",
            jar_sha256 = "b3e51f1a5f3cd6f3ac3232c329952fe6eb310c4114014eed77aaaf7f5c3c902c",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-storageclass/5.3.0/kubernetes-model-storageclass-5.3.0.jar"],        )
    if "k8s_model_autoscaling" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_autoscaling",
            jar_sha256 = "5cdca842e139e6e777ab3d37bcbe067ef52963689e73f6af7e692f68695948b7",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-autoscaling/5.3.0/kubernetes-model-autoscaling-5.3.0.jar"],        )
    if "k8s_model_apps" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_apps",
            jar_sha256 = "d9d4252114590e670762766222cfce7afda44b1ad24188a8a03e930e256ce284",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-apps/5.3.0/kubernetes-model-apps-5.3.0.jar"],        )
    if "k8s_model_events" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_events",
            jar_sha256 = "1120975fc73e2761cc2864ec6c559b2e65146bc5fada54bf4d7fe6601a5ff15a",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-events/5.3.0/kubernetes-model-events-5.3.0.jar"],        )
    if "k8s_model_extensions" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_extensions",
            jar_sha256 = "c960b6b00acd9ba46c9807fd6db94238b7fedb5266f8c279436d645941ff0de0",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-extensions/5.3.0/kubernetes-model-extensions-5.3.0.jar"],        )
    if "k8s_model_networking" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_networking",
            jar_sha256 = "8fb2f0e4fa237b315adc237f7740f1684cdf55b75e3367b7e60135bfe5753f25",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-networking/5.3.0/kubernetes-model-networking-5.3.0.jar"],        )
    if "k8s_model_node" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_node",
            jar_sha256 = "4f20f8c01c887b58b7336e8380de9b2005487ad887989f5d37cb35b6c408b925",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-node/5.3.0/kubernetes-model-node-5.3.0.jar"],        )
    if "k8s_model_policy" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_policy",
            jar_sha256 = "cab2141b8cabdfc76bd746ad511cf05f6bfc9b31545fc1f9e22d7023b0f43613",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-policy/5.3.0/kubernetes-model-policy-5.3.0.jar"],        )
...
artifact_map["@k8s_client//:k8s_client"] = "mvn:io.fabric8:kubernetes-client:jar:NON-OSGI:5.3.0"
artifact_map["@k8s_model//:k8s_model"] = "mvn:io.fabric8:kubernetes-model:jar:NON-OSGI:5.3.0"
artifact_map["@k8s_model_common//:k8s_model_common"] = "mvn:io.fabric8:kubernetes-model-common:jar:5.3.0"
artifact_map["@k8s_model_core//:k8s_model_core"] = "mvn:io.fabric8:kubernetes-model-core:jar:5.3.0"
artifact_map["@k8s_model_rbac//:k8s_model_rbac"] = "mvn:io.fabric8:kubernetes-model-rbac:jar:5.3.0"
artifact_map["@k8s_model_admissionregistration//:k8s_model_admissionregistration"] = "mvn:io.fabric8:kubernetes-model-admissionregistration:jar:5.3.0"
artifact_map["@k8s_model_apiextensions//:k8s_model_apiextensions"] = "mvn:io.fabric8:kubernetes-model-apiextensions:jar:5.3.0"
artifact_map["@k8s_model_batch//:k8s_model_batch"] = "mvn:io.fabric8:kubernetes-model-batch:jar:5.3.0"
artifact_map["@k8s_model_certificates//:k8s_model_certificates"] = "mvn:io.fabric8:kubernetes-model-certificates:jar:5.3.0"
artifact_map["@k8s_model_coordination//:k8s_model_coordination"] = "mvn:io.fabric8:kubernetes-model-coordination:jar:5.3.0"
artifact_map["@k8s_model_discovery//:k8s_model_discovery"] = "mvn:io.fabric8:kubernetes-model-discovery:jar:5.3.0"
artifact_map["@k8s_model_metrics//:k8s_model_metrics"] = "mvn:io.fabric8:kubernetes-model-metrics:jar:5.3.0"
artifact_map["@k8s_model_scheduling//:k8s_model_scheduling"] = "mvn:io.fabric8:kubernetes-model-scheduling:jar:5.3.0"
artifact_map["@k8s_model_storageclass//:k8s_model_storageclass"] = "mvn:io.fabric8:kubernetes-model-storageclass:jar:5.3.0"
artifact_map["@k8s_model_autoscaling//:k8s_model_autoscaling"] = "mvn:io.fabric8:kubernetes-model-autoscaling:jar:5.3.0"
artifact_map["@k8s_model_apps//:k8s_model_apps"] = "mvn:io.fabric8:kubernetes-model-apps:jar:5.3.0"
artifact_map["@k8s_model_events//:k8s_model_events"] = "mvn:io.fabric8:kubernetes-model-events:jar:5.3.0"
artifact_map["@k8s_model_extensions//:k8s_model_extensions"] = "mvn:io.fabric8:kubernetes-model-extensions:jar:5.3.0"
artifact_map["@k8s_model_networking//:k8s_model_networking"] = "mvn:io.fabric8:kubernetes-model-networking:jar:5.3.0"
artifact_map["@k8s_model_node//:k8s_model_node"] = "mvn:io.fabric8:kubernetes-model-node:jar:5.3.0"
artifact_map["@k8s_model_policy//:k8s_model_policy"] = "mvn:io.fabric8:kubernetes-model-policy:jar:5.3.0"
