# ***** This file was auto-generated at Tue, 14 Jan 2020 08:11:15 GMT. Do not edit this file manually. *****
# ***** Use onos-lib-gen *****
...
def generated_maven_jars():
    ...
    if "jackson_annotations" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/com/fasterxml/jackson/core/jackson-annotations/2.10.0/jackson-annotations-2.10.0.jar"],        )
    if "jackson_core" not in native.existing_rules():
        java_import_external(
            name = "jackson_core",
            jar_sha256 = "69e7695b1e40834fa1242fc328a4010607911ced3706ab79abc769d451197513",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/com/fasterxml/jackson/core/jackson-core/2.10.0/jackson-core-2.10.0.jar"],        )
    if "jackson_databind" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/com/fasterxml/jackson/core/jackson-databind/2.10.0/jackson-databind-2.10.0.jar"],        )
    if "jackson_dataformat_yaml" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/com/fasterxml/jackson/dataformat/jackson-dataformat-yaml/2.10.0/jackson-dataformat-yaml-2.10.0.jar"],        )
    ...
    if "validation_api" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/javax/validation/validation-api/2.0.1.Final/validation-api-2.0.1.Final.jar"],        )
    ...
    if "snakeyaml" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/org/yaml/snakeyaml/1.25/snakeyaml-1.25.jar"],        )
    if "k8s_client" not in native.existing_rules():
        java_import_external(
            name = "k8s_client",
            jar_sha256 = "b30d0b9908d4e3f9f6a050d05e568de892f9616de4fecdac131fde3e246bf3c7",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/fabric8/kubernetes-client/4.7.0/kubernetes-client-4.7.0.jar"],        )
    if "k8s_model" not in native.existing_rules():
        java_import_external(
            name = "k8s_model",
            jar_sha256 = "1ecfcd2bfd4ddfe457723af295ef5ec7231f02aafb9c8799fa7fb73d446411fe",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/fabric8/kubernetes-model/4.7.0/kubernetes-model-4.7.0.jar"],        )
