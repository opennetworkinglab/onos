# ***** This file was auto-generated at Thu, 10 Jan 2019 18:38:22 GMT. Do not edit this file manually. *****
# ***** Use onos-lib-gen *****
...
def generated_maven_jars():
    ...
    if "atomix" not in native.existing_rules():
        java_import_external(
            name = "atomix",
            jar_sha256 = "0a799a7a3d777095d20592cdc01f6106a52f4a1065a787e6d35f3cd70731c2f0",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix/3.1.4/atomix-3.1.4.jar"],        )
    if "atomix_cluster" not in native.existing_rules():
        java_import_external(
            name = "atomix_cluster",
            jar_sha256 = "34e73fdc806409bd6880afb83fdfce32c99000745e4491cf71c6d5307505c52b",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix-cluster/3.1.4/atomix-cluster-3.1.4.jar"],        )
    if "atomix_primary_backup" not in native.existing_rules():
        java_import_external(
            name = "atomix_primary_backup",
            jar_sha256 = "b8ffb7732ee996828089f9e46a48c0d81a365d9379e74070b42f3444985844c0",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix-primary-backup/3.1.4/atomix-primary-backup-3.1.4.jar"],        )
    if "atomix_primitive" not in native.existing_rules():
        java_import_external(
            name = "atomix_primitive",
            jar_sha256 = "8269466c843ca7c2860259309514fea013e5497f79d1c9fb4534356ebcd15a56",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix-primitive/3.1.4/atomix-primitive-3.1.4.jar"],        )
    if "atomix_raft" not in native.existing_rules():
        java_import_external(
            name = "atomix_raft",
            jar_sha256 = "95ec0b220957bd38eb2abe0e7a2cb23a82a78cf728fb844ea70403c18d95ee9c",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix-raft/3.1.4/atomix-raft-3.1.4.jar"],        )
    if "atomix_storage" not in native.existing_rules():
        java_import_external(
            name = "atomix_storage",
            jar_sha256 = "54b60453f7aa773824e7c57279bc80ac53bf52d901224f82bf18cf2f7414d6e5",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix-storage/3.1.4/atomix-storage-3.1.4.jar"],        )
    if "atomix_utils" not in native.existing_rules():
        java_import_external(
            name = "atomix_utils",
            jar_sha256 = "eb08977b39cb41e11e792f2b8eb6c44a25068b34c4393f2dde532c35c9c8644a",
            licenses = ["notice"],
            jar_urls = ["http://repo1.maven.org/maven2/io/atomix/atomix-utils/3.1.4/atomix-utils-3.1.4.jar"],        )
...
artifact_map["@atomix//:atomix"] = "mvn:io.atomix:atomix:jar:3.1.4"
artifact_map["@atomix_cluster//:atomix_cluster"] = "mvn:io.atomix:atomix-cluster:jar:3.1.4"
artifact_map["@atomix_primary_backup//:atomix_primary_backup"] = "mvn:io.atomix:atomix-primary-backup:jar:3.1.4"
artifact_map["@atomix_primitive//:atomix_primitive"] = "mvn:io.atomix:atomix-primitive:jar:3.1.4"
artifact_map["@atomix_raft//:atomix_raft"] = "mvn:io.atomix:atomix-raft:jar:3.1.4"
artifact_map["@atomix_storage//:atomix_storage"] = "mvn:io.atomix:atomix-storage:jar:3.1.4"
artifact_map["@atomix_utils//:atomix_utils"] = "mvn:io.atomix:atomix-utils:jar:3.1.4"
