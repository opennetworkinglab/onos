# ***** This file was auto-generated at Tue, 2 Feb 2021 02:42:07 GMT. Do not edit this file manually. *****
# ***** Use onos-lib-gen *****
...
def generated_maven_jars():
    ...
    if "k8s_client" not in native.existing_rules():
        java_import_external(
            name = "k8s_client",
            jar_sha256 = "8d4d8526fcdb700a9723d5c9fcd111d5487b7579846dcc1b31cd9f3f46413d51",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-client/5.0.1/kubernetes-client-5.0.1.jar"],        )
    if "k8s_model" not in native.existing_rules():
        java_import_external(
            name = "k8s_model",
            jar_sha256 = "50173938caaff7abd77fa49e9c87d379b95a0c6fd25bea838fd9202aeaf072c3",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model/5.0.1/kubernetes-model-5.0.1.jar"],        )
    if "k8s_model_common" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_common",
            jar_sha256 = "67a32eb51e0e5af9e8a20aa14fe32a4b94c66960cae301b7cec7d5122b622435",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-common/5.0.1/kubernetes-model-common-5.0.1.jar"],        )
    if "k8s_model_core" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_core",
            jar_sha256 = "3a1a12cbb251ebeb44d657c0d466c02d65200546b3dfd985839f1620fc6947cc",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-core/5.0.1/kubernetes-model-core-5.0.1.jar"],        )
    if "k8s_model_rbac" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_rbac",
            jar_sha256 = "0711f3aebacfba34e5dfc1b20b10e0cdbc86abc67e1b49d61d5f447cb18f4b21",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-rbac/5.0.1/kubernetes-model-rbac-5.0.1.jar"],        )
    if "k8s_model_admissionregistration" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_admissionregistration",
            jar_sha256 = "6e3a5826e10df6742e84c01e1bad54b971ea26f3dc42e64386b7a1b1b161e09c",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-admissionregistration/5.0.1/kubernetes-model-admissionregistration-5.0.1.jar"],        )
    if "k8s_model_apiextensions" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_apiextensions",
            jar_sha256 = "2611c8819e35a2f390fe19c5f9f413891d9a997823c122bbf1862893ff114bfd",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-apiextensions/5.0.1/kubernetes-model-apiextensions-5.0.1.jar"],        )
    if "k8s_model_batch" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_batch",
            jar_sha256 = "c5540dfe6c5d3da00957382d87619b1b4cee6d494897a1f9234990f6b287a494",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-batch/5.0.1/kubernetes-model-batch-5.0.1.jar"],        )
    if "k8s_model_certificates" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_certificates",
            jar_sha256 = "92fddf7fffede2b0b03dfd2ad104ad6de042e9caba03b1267e4151fda0f8fdbc",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-certificates/5.0.1/kubernetes-model-certificates-5.0.1.jar"],        )
    if "k8s_model_coordination" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_coordination",
            jar_sha256 = "d5ebffbd2d69ae6ccf83d499955bd1b862efe195248a8bb885139ff7b5993b73",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-coordination/5.0.1/kubernetes-model-coordination-5.0.1.jar"],        )
    if "k8s_model_discovery" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_discovery",
            jar_sha256 = "0bb13a5129266feb06b2d3edef9d7b2c487cf16d558e3f2ea0a1b960f006c1f9",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-discovery/5.0.1/kubernetes-model-discovery-5.0.1.jar"],        )
    if "k8s_model_metrics" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_metrics",
            jar_sha256 = "81d436f94b58549d16328c6378cefeac6f50641f2ed5f2d0eec9ad3831b7704a",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-metrics/5.0.1/kubernetes-model-metrics-5.0.1.jar"],        )
    if "k8s_model_scheduling" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_scheduling",
            jar_sha256 = "1dd03bb5a0c13be4491f4df9d776fa4341f33c28aada774e97441061dcdabfef",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-scheduling/5.0.1/kubernetes-model-scheduling-5.0.1.jar"],        )
    if "k8s_model_settings" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_settings",
            jar_sha256 = "5b32c16a78ea12898881f9ddff0af452cc31572c1e1ac91c4748843d49ee0324",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-settings/5.0.1/kubernetes-model-settings-5.0.1.jar"],        )
    if "k8s_model_storageclass" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_storageclass",
            jar_sha256 = "5b9e23b14a64d14f21ebfb742265e5a3ee44fb7f0db7d94990c199b07a354f58",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-storageclass/5.0.1/kubernetes-model-storageclass-5.0.1.jar"],        )
    if "k8s_model_autoscaling" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_autoscaling",
            jar_sha256 = "4cca05b25a30fe96b65ce6c03c1f9deec218d08172d74a1ade7a7cf9d4ec544f",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-autoscaling/5.0.1/kubernetes-model-autoscaling-5.0.1.jar"],        )
    if "k8s_model_apps" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_apps",
            jar_sha256 = "255975d07106546ba7e2b299fac532102bb36a33aa7b6bd110015579407fc7e7",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-apps/5.0.1/kubernetes-model-apps-5.0.1.jar"],        )
    if "k8s_model_events" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_events",
            jar_sha256 = "2533a85c919b90494860b116281e6536076c1c050e516a26c0d6512ce91a0774",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-events/5.0.1/kubernetes-model-events-5.0.1.jar"],        )
    if "k8s_model_extensions" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_extensions",
            jar_sha256 = "95ed4d14b710c38b8102acb9a7424ef9558025b78ca3d1a4f0bf130ca1e4ca2d",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-extensions/5.0.1/kubernetes-model-extensions-5.0.1.jar"],        )
    if "k8s_model_networking" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_networking",
            jar_sha256 = "8be7b6592521196b712991055c87214ad4ddf4d0761cad66379818d48ad6e00e",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-networking/5.0.1/kubernetes-model-networking-5.0.1.jar"],        )
    if "k8s_model_node" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_node",
            jar_sha256 = "54cf312f40dc9568a5c927656de5e3cde4f18b981f3e896351d1952a13d339cc",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-node/5.0.1/kubernetes-model-node-5.0.1.jar"],        )
    if "k8s_model_policy" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_policy",
            jar_sha256 = "6ab98f4a7f84f11ca7a52244b5c7ae1ec235ee7e13413653b5b8aecbb64db93f",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-policy/5.0.1/kubernetes-model-policy-5.0.1.jar"],        )
...
artifact_map["@k8s_client//:k8s_client"] = "mvn:io.fabric8:kubernetes-client:jar:NON-OSGI:5.0.1"
artifact_map["@k8s_model//:k8s_model"] = "mvn:io.fabric8:kubernetes-model:jar:NON-OSGI:5.0.1"
artifact_map["@k8s_model_common//:k8s_model_common"] = "mvn:io.fabric8:kubernetes-model-common:jar:5.0.1"
artifact_map["@k8s_model_core//:k8s_model_core"] = "mvn:io.fabric8:kubernetes-model-core:jar:5.0.1"
artifact_map["@k8s_model_rbac//:k8s_model_rbac"] = "mvn:io.fabric8:kubernetes-model-rbac:jar:5.0.1"
artifact_map["@k8s_model_admissionregistration//:k8s_model_admissionregistration"] = "mvn:io.fabric8:kubernetes-model-admissionregistration:jar:5.0.1"
artifact_map["@k8s_model_apiextensions//:k8s_model_apiextensions"] = "mvn:io.fabric8:kubernetes-model-apiextensions:jar:5.0.1"
artifact_map["@k8s_model_batch//:k8s_model_batch"] = "mvn:io.fabric8:kubernetes-model-batch:jar:5.0.1"
artifact_map["@k8s_model_certificates//:k8s_model_certificates"] = "mvn:io.fabric8:kubernetes-model-certificates:jar:5.0.1"
artifact_map["@k8s_model_coordination//:k8s_model_coordination"] = "mvn:io.fabric8:kubernetes-model-coordination:jar:5.0.1"
artifact_map["@k8s_model_discovery//:k8s_model_discovery"] = "mvn:io.fabric8:kubernetes-model-discovery:jar:5.0.1"
artifact_map["@k8s_model_metrics//:k8s_model_metrics"] = "mvn:io.fabric8:kubernetes-model-metrics:jar:5.0.1"
artifact_map["@k8s_model_scheduling//:k8s_model_scheduling"] = "mvn:io.fabric8:kubernetes-model-scheduling:jar:5.0.1"
artifact_map["@k8s_model_settings//:k8s_model_settings"] = "mvn:io.fabric8:kubernetes-model-settings:jar:5.0.1"
artifact_map["@k8s_model_storageclass//:k8s_model_storageclass"] = "mvn:io.fabric8:kubernetes-model-storageclass:jar:5.0.1"
artifact_map["@k8s_model_autoscaling//:k8s_model_autoscaling"] = "mvn:io.fabric8:kubernetes-model-autoscaling:jar:5.0.1"
artifact_map["@k8s_model_apps//:k8s_model_apps"] = "mvn:io.fabric8:kubernetes-model-apps:jar:5.0.1"
artifact_map["@k8s_model_events//:k8s_model_events"] = "mvn:io.fabric8:kubernetes-model-events:jar:5.0.1"
artifact_map["@k8s_model_extensions//:k8s_model_extensions"] = "mvn:io.fabric8:kubernetes-model-extensions:jar:5.0.1"
artifact_map["@k8s_model_networking//:k8s_model_networking"] = "mvn:io.fabric8:kubernetes-model-networking:jar:5.0.1"
artifact_map["@k8s_model_node//:k8s_model_node"] = "mvn:io.fabric8:kubernetes-model-node:jar:5.0.1"
artifact_map["@k8s_model_policy//:k8s_model_policy"] = "mvn:io.fabric8:kubernetes-model-policy:jar:5.0.1"
