...
artifact_map[str(Label("@commons_lang3//jar"))] = "mvn:org.apache.commons:commons-lang3:jar:3.6"
artifact_map[str(Label("@commons_logging//jar"))] = "mvn:commons-logging:commons-logging:jar:1.2"
artifact_map[str(Label("@commons_math3//jar"))] = "mvn:org.apache.commons:commons-math3:jar:3.6.1"
artifact_map[str(Label("@commons_pool//jar"))] = "mvn:commons-pool:commons-pool:jar:1.6"
artifact_map[str(Label("@commons_text//jar"))] = "mvn:org.apache.commons:commons-text:jar:1.2"
...
artifact_map[str(Label("@error_prone_annotations//jar"))] = "mvn:com.google.errorprone:error_prone_annotations:jar:2.0.11"
...
artifact_map[str(Label("@javax_annotation_api//jar"))] = "mvn:javax.annotation:javax.annotation-api:jar:1.2"
...
artifact_map[str(Label("@jersey_container_servlet_core//jar"))] = "mvn:org.glassfish.jersey.containers:jersey-container-servlet-core:jar:2.26"
...
artifact_map[str(Label("@jetty_continuation//jar"))] = "mvn:org.eclipse.jetty:jetty-continuation:jar:9.2.21.v20170120"
artifact_map[str(Label("@jetty_http//jar"))] = "mvn:org.eclipse.jetty:jetty-http:jar:9.2.21.v20170120"
...
artifact_map[str(Label("@netty//jar"))] = "mvn:io.netty:netty:jar:3.10.5.Final"
artifact_map[str(Label("@netty_buffer//jar"))] = "mvn:io.netty:netty-buffer:jar:4.1.8.Final"
artifact_map[str(Label("@netty_codec//jar"))] = "mvn:io.netty:netty-codec:jar:4.1.8.Final"
artifact_map[str(Label("@netty_common//jar"))] = "mvn:io.netty:netty-common:jar:4.1.8.Final"
artifact_map[str(Label("@netty_handler//jar"))] = "mvn:io.netty:netty-handler:jar:4.1.8.Final"
artifact_map[str(Label("@netty_transport//jar"))] = "mvn:io.netty:netty-transport:jar:4.1.8.Final"
artifact_map[str(Label("@netty_transport_native_epoll//jar"))] = "mvn:io.netty:netty-transport-native-epoll:jar:4.1.8.Final"
artifact_map[str(Label("@netty_resolver//jar"))] = "mvn:io.netty:netty-resolver:jar:4.1.8.Final"
artifact_map[str(Label("@netty_codec_http2//jar"))] = "mvn:io.netty:netty-codec-http2:jar:4.1.8.Final"
artifact_map[str(Label("@netty_codec_http//jar"))] = "mvn:io.netty:netty-codec-http:jar:4.1.8.Final"
artifact_map[str(Label("@objenesis//jar"))] = "mvn:org.objenesis:objenesis:jar:2.6"
...
artifact_map[str(Label("@org_osgi_compendium//jar"))] = "mvn:org.osgi:org.osgi.compendium:jar:5.0.0"
...
artifact_map[str(Label("@mibs_rfc//jar"))] = "mvn:org.onosproject:mibbler-mibs-rfc:jar:1.0-20151221.1"
artifact_map[str(Label("@openstack4j_core//jar"))] = "mvn:org.pacesys:openstack4j-core:jar:3.1.0"
artifact_map[str(Label("@openstack4j_http_connector//jar"))] = "mvn:org.pacesys.openstack4j.connectors:openstack4j-http-connector:jar:3.1.0"
artifact_map[str(Label("@openstack4j_httpclient//jar"))] = "mvn:org.pacesys.openstack4j.connectors:openstack4j-httpclient:jar:3.1.0"
artifact_map[str(Label("@json_patch//jar"))] = "mvn:com.github.fge:json-patch:jar:1.9"
artifact_map[str(Label("@jackson_coreutils//jar"))] = "mvn:com.github.fge:jackson-coreutils:jar:1.6"
