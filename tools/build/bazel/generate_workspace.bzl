# ***** This file was auto-generated at Sat, 22 Jan 2022 14:33:54 GMT. Do not edit this file manually. *****
# ***** Use onos-lib-gen *****
...
def generated_maven_jars():
    ...
    if "k8s_client" not in native.existing_rules():
        java_import_external(
            name = "k8s_client",
            jar_sha256 = "01cece997558833f4af979dd26009cdc0830f594bb2530c3b797ef62f9ef9264",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-client/5.6.0/kubernetes-client-5.6.0.jar"],        )
    if "k8s_model" not in native.existing_rules():
        java_import_external(
            name = "k8s_model",
            jar_sha256 = "e3c9ac15df84cc27cac1b5b38b4ae4b78103fbcb043c7dc7cd6a33cb8596fd2a",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model/5.6.0/kubernetes-model-5.6.0.jar"],        )
    if "k8s_model_common" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_common",
            jar_sha256 = "31c60fc9e9f5edd8eff56c23ba347acb11bd191a60cce5286fc562bf971479f3",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-common/5.6.0/kubernetes-model-common-5.6.0.jar"],        )
    if "k8s_model_core" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_core",
            jar_sha256 = "7af9ae607c981d518b1cff6fb1175056ac13e2afa87eaf7b7cc34ae29f179e92",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-core/5.6.0/kubernetes-model-core-5.6.0.jar"],        )
    if "k8s_model_rbac" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_rbac",
            jar_sha256 = "c14af80c4a9d55e604c3babca5a2cba2f0741084b1792781f75928c0b9b8fe8d",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-rbac/5.6.0/kubernetes-model-rbac-5.6.0.jar"],        )
    if "k8s_model_admissionregistration" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_admissionregistration",
            jar_sha256 = "1a43f10060a735d16ad7e9ab4f4c95d6405b2fcef87f9ad3ef5f0826becba332",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-admissionregistration/5.6.0/kubernetes-model-admissionregistration-5.6.0.jar"],        )
    if "k8s_model_apiextensions" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_apiextensions",
            jar_sha256 = "7432ef48e9206156fbab18bdec23332ee0d85479a7e05f2ff2be872360df99ed",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-apiextensions/5.6.0/kubernetes-model-apiextensions-5.6.0.jar"],        )
    if "k8s_model_batch" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_batch",
            jar_sha256 = "ce56cdafc70b626daf3aec907478584bb894397a7298df8fc18cc7b7ea4954e8",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-batch/5.6.0/kubernetes-model-batch-5.6.0.jar"],        )
    if "k8s_model_certificates" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_certificates",
            jar_sha256 = "2269f15b83f3e0e3f0859bbca922825938e1550c800075a3f6f43e6bfac3b99f",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-certificates/5.6.0/kubernetes-model-certificates-5.6.0.jar"],        )
    if "k8s_model_coordination" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_coordination",
            jar_sha256 = "7862d96afe736366ddeeab7422ce98379e8cf858c221cacdbf022f557cfd6245",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-coordination/5.6.0/kubernetes-model-coordination-5.6.0.jar"],        )
    if "k8s_model_discovery" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_discovery",
            jar_sha256 = "478075d3d48dcc4edd5ce93b39030910ecd993d6696e6e16fdba200bdc3d8fd9",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-discovery/5.6.0/kubernetes-model-discovery-5.6.0.jar"],        )
    if "k8s_model_flowcontrol" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_flowcontrol",
            jar_sha256 = "7a60ee14aeff1fd2714302add36c5beadf8243c9111630228acfa784b86c9019",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-flowcontrol/5.6.0/kubernetes-model-flowcontrol-5.6.0.jar"],        )
    if "k8s_model_metrics" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_metrics",
            jar_sha256 = "201e5923a2092261dff8320d2285743e06d49bc056f77415e7d6de867c29cb72",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-metrics/5.6.0/kubernetes-model-metrics-5.6.0.jar"],        )
    if "k8s_model_scheduling" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_scheduling",
            jar_sha256 = "f22821d07c4460a04ab0234a947b787720dac5b109afe4860e8d36480ea3df09",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-scheduling/5.6.0/kubernetes-model-scheduling-5.6.0.jar"],        )
    if "k8s_model_storageclass" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_storageclass",
            jar_sha256 = "547d78c60810d94c549d5f3e58d283ba0f910014b5421af55f4a84a0f6eb486d",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-storageclass/5.6.0/kubernetes-model-storageclass-5.6.0.jar"],        )
    if "k8s_model_autoscaling" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_autoscaling",
            jar_sha256 = "66d7da09494486ad7c57028b89c70ca8c7e7e419dd39ca0b75054c8a9c4409c0",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-autoscaling/5.6.0/kubernetes-model-autoscaling-5.6.0.jar"],        )
    if "k8s_model_apps" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_apps",
            jar_sha256 = "2e63fc8238f728f618028865c834db54181ea8beb65529f35acec0767bbf5fae",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-apps/5.6.0/kubernetes-model-apps-5.6.0.jar"],        )
    if "k8s_model_events" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_events",
            jar_sha256 = "ca3b76a9580fe0ddb5d984a91d61eabd52ac55a4972c14a3c904f1883b107a7f",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-events/5.6.0/kubernetes-model-events-5.6.0.jar"],        )
    if "k8s_model_extensions" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_extensions",
            jar_sha256 = "cc137e6db8be1d03558d3ce2cd547416a299bbfc329065f032aa81f8e366576c",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-extensions/5.6.0/kubernetes-model-extensions-5.6.0.jar"],        )
    if "k8s_model_networking" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_networking",
            jar_sha256 = "92f8c8277e62e83c8c8d8aaefa66c899b03434de4726f582c587e46196edd7c1",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-networking/5.6.0/kubernetes-model-networking-5.6.0.jar"],        )
    if "k8s_model_node" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_node",
            jar_sha256 = "832c3edfc6dbd4fe82f0b6fb872d7fc7db8120973430d743dbded88dd9ac68dd",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-node/5.6.0/kubernetes-model-node-5.6.0.jar"],        )
    if "k8s_model_policy" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_policy",
            jar_sha256 = "55cd41538b6a31467760766ef8b9943f9d458b089ad851413a3244db247e8543",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-policy/5.6.0/kubernetes-model-policy-5.6.0.jar"],        )
...
artifact_map["@k8s_client//:k8s_client"] = "mvn:io.fabric8:kubernetes-client:jar:NON-OSGI:5.6.0"
artifact_map["@k8s_model//:k8s_model"] = "mvn:io.fabric8:kubernetes-model:jar:NON-OSGI:5.6.0"
artifact_map["@k8s_model_common//:k8s_model_common"] = "mvn:io.fabric8:kubernetes-model-common:jar:5.6.0"
artifact_map["@k8s_model_core//:k8s_model_core"] = "mvn:io.fabric8:kubernetes-model-core:jar:5.6.0"
artifact_map["@k8s_model_rbac//:k8s_model_rbac"] = "mvn:io.fabric8:kubernetes-model-rbac:jar:5.6.0"
artifact_map["@k8s_model_admissionregistration//:k8s_model_admissionregistration"] = "mvn:io.fabric8:kubernetes-model-admissionregistration:jar:5.6.0"
artifact_map["@k8s_model_apiextensions//:k8s_model_apiextensions"] = "mvn:io.fabric8:kubernetes-model-apiextensions:jar:5.6.0"
artifact_map["@k8s_model_batch//:k8s_model_batch"] = "mvn:io.fabric8:kubernetes-model-batch:jar:5.6.0"
artifact_map["@k8s_model_certificates//:k8s_model_certificates"] = "mvn:io.fabric8:kubernetes-model-certificates:jar:5.6.0"
artifact_map["@k8s_model_coordination//:k8s_model_coordination"] = "mvn:io.fabric8:kubernetes-model-coordination:jar:5.6.0"
artifact_map["@k8s_model_discovery//:k8s_model_discovery"] = "mvn:io.fabric8:kubernetes-model-discovery:jar:5.6.0"
artifact_map["@k8s_model_flowcontrol//:k8s_model_flowcontrol"] = "mvn:io.fabric8:kubernetes-model-flowcontrol:jar:5.6.0"
artifact_map["@k8s_model_metrics//:k8s_model_metrics"] = "mvn:io.fabric8:kubernetes-model-metrics:jar:5.6.0"
artifact_map["@k8s_model_scheduling//:k8s_model_scheduling"] = "mvn:io.fabric8:kubernetes-model-scheduling:jar:5.6.0"
artifact_map["@k8s_model_storageclass//:k8s_model_storageclass"] = "mvn:io.fabric8:kubernetes-model-storageclass:jar:5.6.0"
artifact_map["@k8s_model_autoscaling//:k8s_model_autoscaling"] = "mvn:io.fabric8:kubernetes-model-autoscaling:jar:5.6.0"
artifact_map["@k8s_model_apps//:k8s_model_apps"] = "mvn:io.fabric8:kubernetes-model-apps:jar:5.6.0"
artifact_map["@k8s_model_events//:k8s_model_events"] = "mvn:io.fabric8:kubernetes-model-events:jar:5.6.0"
artifact_map["@k8s_model_extensions//:k8s_model_extensions"] = "mvn:io.fabric8:kubernetes-model-extensions:jar:5.6.0"
artifact_map["@k8s_model_networking//:k8s_model_networking"] = "mvn:io.fabric8:kubernetes-model-networking:jar:5.6.0"
artifact_map["@k8s_model_node//:k8s_model_node"] = "mvn:io.fabric8:kubernetes-model-node:jar:5.6.0"
artifact_map["@k8s_model_policy//:k8s_model_policy"] = "mvn:io.fabric8:kubernetes-model-policy:jar:5.6.0"
