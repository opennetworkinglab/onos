# ***** This file was auto-generated at Fri, 19 Feb 2021 02:49:14 GMT. Do not edit this file manually. *****
# ***** Use onos-lib-gen *****
...
def generated_maven_jars():
    ...
    if "k8s_client" not in native.existing_rules():
        java_import_external(
            name = "k8s_client",
            jar_sha256 = "8d7f37f5905249460e5fdf4bb03e07ae6fb35ae8e04670d382e47f18f830e840",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-client/5.1.0/kubernetes-client-5.1.0.jar"],        )
    if "k8s_model" not in native.existing_rules():
        java_import_external(
            name = "k8s_model",
            jar_sha256 = "6dec94c1d638aa347bfe842a29971263c5742c667a273801e0ec54f9a519afe5",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model/5.1.0/kubernetes-model-5.1.0.jar"],        )
    if "k8s_model_common" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_common",
            jar_sha256 = "5c7d3728bd64f9a7a1665a0dabad5743e34021d259ebfc51db94505a6c3bb49a",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-common/5.1.0/kubernetes-model-common-5.1.0.jar"],        )
    if "k8s_model_core" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_core",
            jar_sha256 = "11c901736d7368ea5037e9bd95e2ac8e0d53ec3f1705e620978ca580a3d6a177",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-core/5.1.0/kubernetes-model-core-5.1.0.jar"],        )
    if "k8s_model_rbac" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_rbac",
            jar_sha256 = "ee7ade5f713adcf4b9904f21f50adf43d16616c3288239e7086b7811ce6015ba",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-rbac/5.1.0/kubernetes-model-rbac-5.1.0.jar"],        )
    if "k8s_model_admissionregistration" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_admissionregistration",
            jar_sha256 = "03dee249632178a8995a169cfb4cedff2595d39589349719c426353017f14d47",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-admissionregistration/5.1.0/kubernetes-model-admissionregistration-5.1.0.jar"],        )
    if "k8s_model_apiextensions" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_apiextensions",
            jar_sha256 = "c8e18a4f01d7e70bf990aa3f5c0771d61f17df4373b8b3cd2fc390f84786bd55",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-apiextensions/5.1.0/kubernetes-model-apiextensions-5.1.0.jar"],        )
    if "k8s_model_batch" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_batch",
            jar_sha256 = "04147d37e18e7ed96c9fa65eb18013ccdd315d476d0a8be97df6b3b3486a15b3",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-batch/5.1.0/kubernetes-model-batch-5.1.0.jar"],        )
    if "k8s_model_certificates" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_certificates",
            jar_sha256 = "6a8f3d75eab12b57df3682d735fd11e2be4951e947f4d3dc91ff2c1ec0d0f6d6",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-certificates/5.1.0/kubernetes-model-certificates-5.1.0.jar"],        )
    if "k8s_model_coordination" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_coordination",
            jar_sha256 = "a2a538f53fb884fa0fcaac7db72b8d3494be69e18a8390de5fd2ebf932f7ecab",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-coordination/5.1.0/kubernetes-model-coordination-5.1.0.jar"],        )
    if "k8s_model_discovery" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_discovery",
            jar_sha256 = "2bfaafb96cc747194e623e1964ce626b63d4f1e6d2b7d1f85d9c8edcf326837a",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-discovery/5.1.0/kubernetes-model-discovery-5.1.0.jar"],        )
    if "k8s_model_metrics" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_metrics",
            jar_sha256 = "0b267c7968f247ed3b702fcb630adc18a968fa2b6b5a0960790e1b58c3e4a14d",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-metrics/5.1.0/kubernetes-model-metrics-5.1.0.jar"],        )
    if "k8s_model_scheduling" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_scheduling",
            jar_sha256 = "9a468b7326f7c1c58cafe6887ef0a5c668c5bbe508e5b5dba5868e7f3ff21885",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-scheduling/5.1.0/kubernetes-model-scheduling-5.1.0.jar"],        )
    if "k8s_model_storageclass" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_storageclass",
            jar_sha256 = "30a300f1bc5e186f7a7aeec4424b5485e35d67c308be86842814ad3e07ab47f1",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-storageclass/5.1.0/kubernetes-model-storageclass-5.1.0.jar"],        )
    if "k8s_model_autoscaling" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_autoscaling",
            jar_sha256 = "204d486cfb70e93105a10ee043673a18492cfa0583c304652c6e7e2257283b63",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-autoscaling/5.1.0/kubernetes-model-autoscaling-5.1.0.jar"],        )
    if "k8s_model_apps" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_apps",
            jar_sha256 = "08a335f1b5a78cb750d21c98b4204c6b2b980c1ef98ab80f1b5b5c1d300a2dd0",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-apps/5.1.0/kubernetes-model-apps-5.1.0.jar"],        )
    if "k8s_model_events" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_events",
            jar_sha256 = "7521975351564e805686d510eb174aaf8c5aeac4753b934bb0f07c50de870239",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-events/5.1.0/kubernetes-model-events-5.1.0.jar"],        )
    if "k8s_model_extensions" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_extensions",
            jar_sha256 = "47427570bd57024cdff8481d0196b087989d3307b9055198d8047a3b6bb40686",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-extensions/5.1.0/kubernetes-model-extensions-5.1.0.jar"],        )
    if "k8s_model_networking" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_networking",
            jar_sha256 = "d0fd2ac543710a7f0260738e22d4beddcf7bc890abab13668dafee948bfb7dd6",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-networking/5.1.0/kubernetes-model-networking-5.1.0.jar"],        )
    if "k8s_model_node" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_node",
            jar_sha256 = "67ee8ef4f34670ed91cea5f5992ff41e629dad143d2da64e79be486412387a8f",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-node/5.1.0/kubernetes-model-node-5.1.0.jar"],        )
    if "k8s_model_policy" not in native.existing_rules():
        java_import_external(
            name = "k8s_model_policy",
            jar_sha256 = "4fea2f8dbff10ccfbdffd0220514f5614911ffefe51c697e3acf555fa773b2bc",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/fabric8/kubernetes-model-policy/5.1.0/kubernetes-model-policy-5.1.0.jar"],        )
...
artifact_map["@k8s_client//:k8s_client"] = "mvn:io.fabric8:kubernetes-client:jar:NON-OSGI:5.1.0"
artifact_map["@k8s_model//:k8s_model"] = "mvn:io.fabric8:kubernetes-model:jar:NON-OSGI:5.1.0"
artifact_map["@k8s_model_common//:k8s_model_common"] = "mvn:io.fabric8:kubernetes-model-common:jar:5.1.0"
artifact_map["@k8s_model_core//:k8s_model_core"] = "mvn:io.fabric8:kubernetes-model-core:jar:5.1.0"
artifact_map["@k8s_model_rbac//:k8s_model_rbac"] = "mvn:io.fabric8:kubernetes-model-rbac:jar:5.1.0"
artifact_map["@k8s_model_admissionregistration//:k8s_model_admissionregistration"] = "mvn:io.fabric8:kubernetes-model-admissionregistration:jar:5.1.0"
artifact_map["@k8s_model_apiextensions//:k8s_model_apiextensions"] = "mvn:io.fabric8:kubernetes-model-apiextensions:jar:5.1.0"
artifact_map["@k8s_model_batch//:k8s_model_batch"] = "mvn:io.fabric8:kubernetes-model-batch:jar:5.1.0"
artifact_map["@k8s_model_certificates//:k8s_model_certificates"] = "mvn:io.fabric8:kubernetes-model-certificates:jar:5.1.0"
artifact_map["@k8s_model_coordination//:k8s_model_coordination"] = "mvn:io.fabric8:kubernetes-model-coordination:jar:5.1.0"
artifact_map["@k8s_model_discovery//:k8s_model_discovery"] = "mvn:io.fabric8:kubernetes-model-discovery:jar:5.1.0"
artifact_map["@k8s_model_metrics//:k8s_model_metrics"] = "mvn:io.fabric8:kubernetes-model-metrics:jar:5.1.0"
artifact_map["@k8s_model_scheduling//:k8s_model_scheduling"] = "mvn:io.fabric8:kubernetes-model-scheduling:jar:5.1.0"
artifact_map["@k8s_model_storageclass//:k8s_model_storageclass"] = "mvn:io.fabric8:kubernetes-model-storageclass:jar:5.1.0"
artifact_map["@k8s_model_autoscaling//:k8s_model_autoscaling"] = "mvn:io.fabric8:kubernetes-model-autoscaling:jar:5.1.0"
artifact_map["@k8s_model_apps//:k8s_model_apps"] = "mvn:io.fabric8:kubernetes-model-apps:jar:5.1.0"
artifact_map["@k8s_model_events//:k8s_model_events"] = "mvn:io.fabric8:kubernetes-model-events:jar:5.1.0"
artifact_map["@k8s_model_extensions//:k8s_model_extensions"] = "mvn:io.fabric8:kubernetes-model-extensions:jar:5.1.0"
artifact_map["@k8s_model_networking//:k8s_model_networking"] = "mvn:io.fabric8:kubernetes-model-networking:jar:5.1.0"
artifact_map["@k8s_model_node//:k8s_model_node"] = "mvn:io.fabric8:kubernetes-model-node:jar:5.1.0"
artifact_map["@k8s_model_policy//:k8s_model_policy"] = "mvn:io.fabric8:kubernetes-model-policy:jar:5.1.0"
