...
(function () {
    ...
    // NOTE: when adding glyphs, please also update TopoConstants.Glyphs class.
        ...
        laser = "M47.2,68.4L31.1,84.5,25.6,79,41.7,62.9Z" +
            ...
            "m6.8-5.2-3.8-3.8a0.9,0.9,0,0,0-1.3,0h0a0.9,0.9,0,0,0,0,1.3" +
            "L71.8,31A0.9,0.9,0,0,0,73,31h0A0.9,0.9,0,0,0,73.1,29.7Z" +
            "M84.8,40.9L80.9,37a0.9,0.9,0,0,0-1.3,0h0a0.9,0.9,0,0,0,0,1.3" +
            "l3.9,3.9a0.9,0.9,0,0,0,1.3,0h0A0.9,0.9,0,0,0,84.8,40.9Z" +
