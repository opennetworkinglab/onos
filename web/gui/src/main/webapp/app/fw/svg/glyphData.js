...
(function () {
    ...
    // NOTE: when adding glyphs, please also update TopoConstants.Glyphs class.
        ...
        mojoDataSet = {
            ...
            mojo_map: 'M83.4,50.8A33.2,33.2,0,1,1,50.3,17.6,33.3,33.3,0,' +
            '0,1,83.4,50.8Zm-62.6-.1A29.4,29.4,0,1,0,50.4,21.4,29.4,29.4,0,' +
            '0,0,20.8,50.7ZM65.5,47.6h9.2' +
            'a1.9,1.9,0,0,1,1.8,2.7,2,2,0,0,1-2,1.2H65.6c0,0.5-.1.9-0.1,1.4' +
            'a38.6,38.6,0,0,1-8.3,21.8,1.9,1.9,0,0,1-2.8.5,1.9,1.9,' +
            '0,0,1-.3-2.8,34.4,34.4,0,0,0,5.4-9.7A33.8,33.8,0,0,0,61.6,52' +
            'c0-.2,0-0.3,0-0.5H39c0.2,1.8.3,3.5,0.6,5.2a34.6,34.6,0,0,0,' +
            '7.2,15.8,1.9,1.9,0,1,1-3,2.4,37.4,37.4,0,0,1-6.8-12.7,41.6,41.6,' +
            '0,0,1-1.8-10.3V51.4H26a2,2,0,0,1-2.1-1.7,2,2,0,0,1,2-2.2h9.4' +
            'c0.3-1.9.6-3.8,0.9-5.6a37.8,37.8,0,0,1,7.8-16.5,1.9,1.9,0,0,' +
            '1,2.8-.3,2,2,0,0,1,.1,2.9,64.5,64.5,0,0,0-3.7,5.6,34.8,34.8,0,0,' +
            '0-3.9,13.3c0,0.2,0,.4,0,0.6H61.7c-0.3-1.9-.6-3.7-1-5.6' +
            'a34.1,34.1,0,0,0-7.2-14.5,1.9,1.9,0,0,1-.3-2.3,1.7,1.7,0,0,' +
            '1,1.9-.9,2.9,2.9,0,0,1,1.4.9,37.4,37.4,0,0,1,8.1,16.9' +
            'c0.3,1.6.5,3.2,0.7,4.7v0.7Z',

            mojo_selectMap: 'M30.8,61.9l8.5-6.3c-0.7-2.6-1.5-5.1-2-7.6' +
            'a49.4,49.4,0,0,1-.7-5.6c0-.5-0.2-0.7-0.7-0.7H27.1' +
            'a1.9,1.9,0,0,1-1.9-2.6,1.9,1.9,0,0,1,1.9-1.2h9.4' +
            'c0.2-1.5.4-2.9,0.6-4.4a38.7,38.7,0,0,1,8-17.8,1.9,1.9,0,1,1,3,2.4' +
            'c-1,1.5-2.1,2.9-3,4.4a34.9,34.9,0,0,0-4.7,14.4,8.2,8.2,0,0,0,0,.9' +
            'H63.1c-0.3-2-.6-3.9-1-5.8a33.4,33.4,0,0,0-7.1-14.3' +
            'A2,2,0,0,1,56,14.5a1.8,1.8,0,0,1,1.8.7,37.7,37.7,0,0,1,7.9,15.7' +
            'c0.5,2.2.8,4.5,1.3,6.9h9.2a1.9,1.9,0,0,1,1,3.5,2.9,2.9,0,0,1-1.3.3' +
            'H67c-0.1,1.2-.2,2.3-0.4,3.5a38.4,38.4,0,0,1-8.1,19.7,1.9,1.9,' +
            '0,0,1-2.9.5,2,2,0,0,1-.1-3,34.9,34.9,0,0,0,7-15.8' +
            'c0.3-1.6.4-3.2,0.6-4.9H40.5c-0.3,2.4,1.1,9.4,2.2,11.3l5.5-4.1' +
            'a2.1,2.1,0,0,1,3.5,1.9L50.3,71.2,49.1,88.6c0,0.7-.1,1.3-0.1,2' +
            'a2,2,0,0,1-1.4,1.8,1.9,1.9,0,0,1-2.2-.9l-3.9-5.6-5.9-8.6' +
            'a1,1,0,0,0-.9-0.5l-14.8-.5H17.4a1.9,1.9,0,0,1-1.9-1.3,1.9,1.9,' +
            '0,0,1,.7-2.2l5.2-3.8,5.8-4.3,0.3-.3-2.4-2.8' +
            'A33.2,33.2,0,0,1,44.8,8.5a32.8,32.8,0,0,1,37,19' +
            'c5.4,12.5,3.7,24.4-4.9,35A31.9,31.9,0,0,1,55.9,74H54.8' +
            'a1.8,1.8,0,0,1-2-1.7,2,2,0,0,1,1.8-2.1l3.5-.6' +
